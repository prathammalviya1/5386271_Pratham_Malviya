...
int count_swaps(int n, int* arr, int ascending) {
    ...
    if (ascending)
        ...
        qsort(pairs, n, sizeof(Pair), cmp_desc);
...
int lilysHomework(int arr_count, int* arr) {
    int swaps_asc = count_swaps(arr_count, arr, 1);
    int swaps_desc = count_swaps(arr_count, arr, 0);
